...
IN_H = 8     # Input height (smaller for int32)
IN_W = 8     # Input width (smaller for int32)
K_H = 3       # Kernel height
K_W = 3       # Kernel width
...
def conv2d_simple(input_tensor: Annotated[torch.Tensor, "shape: (8, 8)"], 
                  kernel: Annotated[torch.Tensor, "shape: (3, 3)"]) -> Annotated[torch.Tensor, "shape: (10, 10)"]:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_path", type=str, default="kernels/conv_small.cc")
