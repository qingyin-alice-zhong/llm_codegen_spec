...
def matrix_multiply(A: Annotated[torch.Tensor, "shape: (64, 64)"], B: Annotated[torch.Tensor, "shape: (64, 64)"]) -> Annotated[torch.Tensor, "shape: (64, 64)"]:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--kernel_path", type=str, default="kernels/gemm_kernel.cc")
    args = parser.parse_args()

    _test_matrix_multiply(args.kernel_path) 