...
def reference_hardsigmoid_bfloat16(x0: Annotated[np.ndarray, "shape: (256,)"] -> Annotated[np.ndarray, "shape: (256,)"]):
    return np.clip(bfloat16(0.2) * x + bfloat16(0.5), bfloat16(0), bfloat16(1)).astype(bfloat16)
# Reference code ends


def _test_hardsigmoid_bfloat16(kernel_path: str):
    hardsigmoid_bfloat16_kernel = ExternalModule(
        top="hardsigmoid_bfloat16",
    ...
    if "MLIR_AIE_INSTALL_DIR" in os.environ:
        ...
        # ===== Analyze trace via shared utility if generated under top.prj/ =====
        analyze_trace(top_prj_dir=TOP_PRJ_ABS_DIR, targetname="hardsigmoid_bfloat16", colshift=1)
...
if __name__ == "__main__":
    ...
    _test_hardsigmoid_bfloat16(args.kernel_path)
