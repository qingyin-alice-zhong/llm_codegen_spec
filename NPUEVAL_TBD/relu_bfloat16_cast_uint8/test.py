...
def reference_relu_bfloat16_cast_uint8(x0: Annotated[np.ndarray, "shape: (256,)"] -> Annotated[np.ndarray, "shape: (256,)"]):
    return clipped.astype(np.uint8)
# Reference code ends


def _test_relu_bfloat16_cast_uint8(kernel_path: str):
    relu_bfloat16_cast_uint8_kernel = ExternalModule(
        top="relu_bfloat16_cast_uint8",
    ...
    if "MLIR_AIE_INSTALL_DIR" in os.environ:
        ...
        # ===== Analyze trace via shared utility if generated under top.prj/ =====
        analyze_trace(top_prj_dir=TOP_PRJ_ABS_DIR, targetname="relu_bfloat16_cast_uint8", colshift=1)
...
if __name__ == "__main__":
    ...
    _test_relu_bfloat16_cast_uint8(args.kernel_path)
